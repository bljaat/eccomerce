...
if (isset($_POST['toggleStatus'])) {
    ...
    $sql = "UPDATE `aterbute` SET `status` = " . $status . " WHERE id = " . $id . "";
...
$query = "SELECT * FROM aterbute LIMIT $start, $limit";
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                ?>
                                        <tr style="align-items: center;">
                                            <td style="width: 20%;"><?php echo $row['attribute_name'] ?></td>
                                            <td>
                                            ...
                                            <td>
                                                <a class="btn btn-block btn-primary btn-sm" href="../values/index.php?id=<?php echo $row['id'] ?>">manage Value</a>
