...
if (isset($_POST['submit'])) {
    if (!empty($_POST['full_name']) && !empty($_POST['email']) && !empty($_POST['password']) && !empty($_POST['retype_password']) && !empty($_POST['agree'])) {
...
<body class="hold-transition register-page">
    ...
    <!-- jQuery -->
    <script src="<?php echo ADMIN_ASSET ?>plugins/jquery/jquery.min.js"></script>
    <!-- Bootstrap 4 -->
    <script src="<?php echo ADMIN_ASSET ?>plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
    <!-- AdminLTE App -->
    <script src="<?php echo ADMIN_ASSET ?>dist/js/adminlte.min.js"></script>
</body>
